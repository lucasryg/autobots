...
export default function Chat() {
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      <div className="w-full max-w-[320px] h-[65vh] sm:h-[640px] bg-black rounded-[2.5rem] border-8 border-gray-900 shadow-2xl relative overflow-hidden">
        {/* Câmera frontal */}
        ...
        {/* Conteúdo do chat */}
        <div className="flex flex-col justify-end h-full p-3 space-y-3 bg-[#111827] text-sm">
          {/* Mensagem do bot */}
